...
PARAM_PATTERNS = {
    ...
    'grasp_orientation': (r'(output_key="grasp_orientation" value=")[^"]*(")',
                          r'\g<1>{value}\g<2>',
                          "the 'grasp_orientation' SetBlackboard"),
    'grip_effort': (r'(output_key="grip_effort" value=")[^"]*(")',
                    r'\g<1>{value}\g<2>',
                    "the 'grip_effort' SetBlackboard"),
